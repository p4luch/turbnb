defmodule Turbnb.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Turbnb.Repo)
  ...
  """
  def valid_password?(%Turbnb.Accounts.User{hashed_password: hashed_password}, password)
